...
:root{color-scheme:light dark;--bg:var(--vscode-editor-background);--panel:var(--vscode-sideBar-background);--line:var(--vscode-widget-border);--muted:var(--vscode-descriptionForeground);--accent:var(--vscode-focusBorder,var(--vscode-button-background));--good:var(--vscode-testing-iconPassed);--warn:var(--vscode-editorWarning-foreground);--bad:var(--vscode-editorError-foreground);--project-memory-col:16px;--project-count-col:3ch;--usage-limit-bar-width:52px}
