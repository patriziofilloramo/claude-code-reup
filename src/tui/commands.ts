...
export const COMMANDS: readonly CommandDef[] = [
  ...
  {
    id: 'focus-branch-drift',
    group: 'navigation',
    keybinding: '',
    visibleWhen: 'always',
    label: 'Focus: Branch drift',
  },
  {
    id: 'focus-path-missing',
    group: 'navigation',
    keybinding: '',
    visibleWhen: 'always',
    label: 'Focus: Path missing',
  },
  {
    id: 'focus-high-context',
    group: 'navigation',
    keybinding: '',
    visibleWhen: 'always',
    label: 'Focus: High context',
  },
  {
    id: 'focus-expiring',
    group: 'navigation',
