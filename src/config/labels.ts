...
export const LABELS = {
  ...
  configSyncLegendLinked: 'linked',
  configSyncLegendLinkedDesc: 'synced to cloud',
  configSyncLegendCloud: 'cloud',
  configSyncLegendCloudDesc: 'in cloud folder, not linked',
  configSyncLegendLocal: 'local',
  configSyncLegendLocalDesc: 'not in cloud folder',
