...
export const LABELS = {
  ...
  configSelect: 'select',
  configSyncLinkCurrent: 'Link current project',
  configSyncUnlinkCurrent: 'Unlink current project',
  configSyncCurrentLinked: 'Current project linked',
  configSyncCurrentLinkedActive: 'active — unlink unavailable',
  configSyncCurrentLocalActive: 'active — linking unavailable',
  configSyncLinkAllCloud: 'Link all cloud projects',
  configSyncUnlinkAll: 'Unlink all synced projects',
  configSyncCandidates: 'candidates',
  ...
  configSyncExpandSection: 'enter to show',
  configSyncCollapseSection: 'enter to hide',
  configSyncRemoteScanning: 'searching cloud folders...',
  configSyncNone: 'none',
  configSyncForgetHint: 'f forget local copy',
  configSyncForgetConfirm: 'press f again to forget; local data remains recoverable',
  configCloudIconLinkedShort: 'linked',
  configCloudIconUnlinkedUseShort: 'unlinked use',
  configCloudIconOfflineShort: 'offline',
  configCloudIconLegendTitle: 'Legend',
  configCloudIconOnline: 'linked here — shared memory reachable',
