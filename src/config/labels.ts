...
export const LABELS = {
  ...
  configSyncLinkedProjectsTitle: 'Linked Cloud Projects',
  configSyncUnlinkedProjectsTitle: 'Unlinked Cloud Projects',
  configCloudIconLegendTitle: 'Legend',
  configCloudIconOnline: 'online — all devices syncing',
  configCloudIconPartial: 'partial — some devices not linked',
  configCloudIconOffline: 'offline — cloud folder unreachable',
